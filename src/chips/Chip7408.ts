...
class Chip7408 extends Chip {
    ...
    update(): void {
        this.Y1.state = NS.and(this.A1.state, this.B1.state);
        this.Y2.state = NS.and(this.A2.state, this.B2.state);
        this.Y3.state = NS.and(this.A3.state, this.B3.state);
        this.Y4.state = NS.and(this.A4.state, this.B4.state);
    }
}
